...
\begin{itemize}
    ...
    \item En el sector de Información y Comunicación ($J$), donde la penetración de herramientas de software y ciencia de datos es nativa y más extendida, el coeficiente es muy próximo a cero ($\beta = -0,0009$) y estadísticamente no significativo. Esto sugiere que las empresas del sector absorben estas innovaciones con escasa fricción organizacional, pero sin experimentar un salto de productividad contemporáneo desproporcionado respecto de su elevado nivel de partida.
    \item En Actividades Profesionales, Científicas y Técnicas ($M$), se observa un coeficiente negativo leve pero significativo al 5\% ($\beta = -0,0028$), lo que refleja posibles tiempos de aprendizaje en servicios basados en conocimiento.
    \item En Alojamiento y Servicios de Comida ($I$), el coeficiente resulta positivo y significativo ($\beta = 0,0118$, $p=0,010$). Si bien este comportamiento puede responder a un sesgo de selección en un sector con baja adopción basal (4,7\% de empresas en promedio), donde las pocas unidades adoptantes implementaron herramientas específicas de alta rentabilidad (como sistemas automatizados de reservas y fijación dinámica de precios), también debe interpretarse con cautela por coincidir con la fase de reapertura y normalización post-pandemia que experimentó el turismo europeo entre 2021 y 2024.
...
\begin{itemize}
    ...
    \item \textbf{Sectores intensivos en información:} en el sector de Información y Comunicación, la absorción tecnológica se produce sobre una infraestructura digital ya madura, amortiguando los costos de ajuste pero sin generar una aceleración explosiva inmediata sobre niveles de productividad que ya se encontraban entre los más elevados de la economía.
    \item \textbf{Servicios con baja penetración basal:} en Alojamiento y Comida, el coeficiente positivo refleja tanto la adopción puntual de herramientas comerciales y de reservas en firmas de punta como la fuerte recuperación cíclica de la actividad tras el levantamiento de las restricciones sanitarias de la pandemia.
\end{itemize}

\subsection{La brecha de realización productiva y las fricciones de optimización}

La evidencia reunida sustenta la noción de una \textbf{brecha de realización productiva}: una divergencia visible entre la rapidez con la que se difunde el uso formal de herramientas de IA en las empresas europeas y el tiempo que insume la maduración de esas tecnologías para reflejarse en mejoras tangibles de eficiencia agregada.
