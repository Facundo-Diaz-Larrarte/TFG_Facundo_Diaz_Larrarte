...
La literatura sobre complementariedades organizacionales y tecnologías de propósito general \citep{bresnahan2002information} y los desarrollos recientes en la frontera algorítmica destacan que la productividad no emerge del uso pasivo de herramientas genéricas no integradas, sino del rediseño adaptativo de los procesos productivos orientado a cuellos de botella específicos de la función de producción. En manufactura y logística, esto abarca el mantenimiento predictivo, la planificación dinámica de inventarios o la sincronización ciberfísica; en servicios, la automatización analítica de operaciones complejas o la reducción de tiempos en flujos documentales críticos. Cuando la adopción empresarial se limita a contratar licencias de software sin acoplar los modelos a los cuellos de botella reales de la firma, la tecnología incrementa los costos operativos corrientes sin traducirse en mejoras observables del valor agregado por persona, manteniendo transitoriamente a la economía en el tramo deprimido de la curva J.
...
\begin{enumerate}
    \item \textbf{Divergencia entre corte transversal y dinámica temporal:} existe una asociación positiva robusta en niveles entre adopción de IA y productividad laboral aparente en el conjunto de la UE-27, pero dicha relación no se sostiene como un efecto temporal positivo al controlar estrictamente por factores estructurales fijos de cada país--sector y shocks país--año. Este contraste empírico alerta contra el error común de inferir rendimientos productivos inmediatos a partir de simples comparaciones transversales.
