...
\begin{itemize}
    \item En sectores con cadenas logísticas complejas e intensivos en capital físico, como la Industria Manufacturera ($C$) y el Comercio ($G$), las pendientes dentro de entidad son negativas y estadísticamente significativas al 1\% ($\beta = -0,0095$ y $\beta = -0,0134$, respectivamente). Este comportamiento es consistente con la existencia de severos costos de ajuste y reorganización en actividades de alta complejidad operativa, coincidiendo plenamente con la fase descendente de la curva J de productividad durante las etapas de despliegue inicial.
...
\begin{enumerate}
    ...
    \item \textbf{Horizonte temporal:} con sólo tres olas comparables (2021, 2023 y 2024), la capacidad para identificar efectos dinámicos rezagados es limitada. Si los retornos productivos de la IA maduran con rezagos de varios años, el diseño actual captura únicamente la etapa inicial de costos de transición de la curva J.
...
Este Trabajo Final de Grado se propuso analizar cómo varían la adopción y los usos empresariales de inteligencia artificial entre sectores económicos de la Unión Europea y en qué medida dichas diferencias se asocian con niveles y variaciones de productividad laboral aparente, mediante la construcción de una base de panel país--sector--año reproducible a partir de microdatos agregados de Eurostat para los años 2021, 2023 y 2024.

Los resultados alcanzados permiten extraer tres conclusiones principales:
\begin{enumerate}
    \item \textbf{Divergencia entre corte transversal y dinámica temporal (hallazgo empírico central):} la fuerte asociación positiva en niveles entre adopción de IA y productividad laboral aparente en el conjunto de la UE-27 ($r = 0,564$) se desvanece por completo al explotar la variación temporal dentro de cada país--sector y controlar por shocks macroeconómicos país--año. Este resultado econométrico demuestra que la aparente ventaja productiva de la IA en datos agregados responde principalmente a un sesgo de selección y a factores estructurales preexistentes de nivel, y no a una ganancia contemporánea inmediata derivada de la adopción.
    \item \textbf{Heterogeneidad estructural sectorial:} la respuesta temporal de la productividad no es homogénea entre sectores. Las actividades con alta complejidad física y de coordinación (manufactura y comercio) exhiben pendientes temporales negativas compatibles con la etapa inicial de costos de ajuste de la curva J, mientras que los servicios informáticos absorben la tecnología sin disrupciones pero con impactos contemporáneos neutros.
